...
class Cube:
    ...
    def printCube(self):
        ...
        print(
                                                            ...
                                                            "    " + self.cube[0][7] + wCenter + self.cube[0][3] + "\n" +
                    ...
                    self.cube[1][7] + oCenter + self.cube[1][3] + " " + self.cube[2][7] + gCenter + self.cube[2][3] + " " + self.cube[3][7] + rCenter + self.cube[3][3] + " " + self.cube[4][7] + bCenter + self.cube[4][3] + "\n" +
                    self.cube[1][6] + self.cube[1][5] + self.cube[1][4] + " " + self.cube[2][6] + self.cube[2][5] + self.cube[2][4] + " " + self.cube[3][6] + self.cube[3][5] + self.cube[3][4] + " " + self.cube[4][6] + self.cube[4][5] + self.cube[4][4] + "\n\n" +
                                                            ...
                                                            "    " + self.cube[5][7] + yCenter + self.cube[5][3] + "\n" +
